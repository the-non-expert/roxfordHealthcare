<script>
  ...
  import { gynecareMedicineDetails } from "../../../lib/GynecareMedicineList.js";
  ...
  let medicines = gynecareMedicineDetails;
...
<div class="p-4">
  <p class="font-bold text-center text-5xl mb-8">Gynecare</p>
  ...
  >
    ...
    {:else}
      {#each filteredMedicines as medicine}
        ...
        <div
          class="border p-3 rounded flex flex-col items-center cursor-pointer"
