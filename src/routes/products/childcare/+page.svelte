<script>
  ...
  import { childcareMedicineDetails } from "../../../lib/ChildcareMedicineList.js";
  ...
  let medicines = childcareMedicineDetails;
...
<div class="p-4">
  <p class="font-bold text-center text-5xl mb-8">Child Care</p>
