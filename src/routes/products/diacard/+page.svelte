<script>
  ...
  import { diacareMedicineDetails } from "../../../lib/DiacareMedicineList.js";
  ...
  let medicines = diacareMedicineDetails;
...
<div class="p-4">
  <p class="font-bold text-center text-5xl mb-8">Diacare</p>
